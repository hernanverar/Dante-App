...
import AboutDataInfo from "./AboutDataInfo";
...
export default class AboutMenu extends Component {
  ...
  render() {
    ...
    const menuItems = ["HISTORIA", "VISAS APROBADAS", "TESTIMONIOS"];
    const activeMenuTitle = menuItems[activeMenuItem - 1];
    const activeMenuIcon =
      activeMenuTitle === "HISTORIA"
        ? personalIcon
        : activeMenuTitle === "VISAS APROBADAS"
        ? educationIcon
        : careerIcon;

    const subheadings = AboutDataInfo[activeMenuItem];
